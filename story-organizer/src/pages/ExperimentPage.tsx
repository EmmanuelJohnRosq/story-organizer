...
export default function ExperimentPage() {
  ...
  return (
    ...
    <div className="w-full mx-auto flex justify-center gap-2 pt-15">
        ...
        {/* NOTES BUTTON DISPLAY STATE */}
        <button 
          onClick={displayNotes}
          className="bg-green-800 p-2 -mr-1 rounded-l-2xl hover:bg-green-700 transition">
          <span className="[writing-mode:vertical-rl] [text-orientation:upright] text-bold">NOTES</span>
        </button>

        {notesShowState && (
          // {/* RIGHT SIDE CONTAINER */}
          <div className="hidden xs:block flex-1 flex flex-col relative transition delay-500 duration-900">
