...
export default function ExperimentPage() {
  ...
  return (
    ...
    <div className="pt-15 xxs:pt-0 w-full mx-auto px-2">
        ...
        {/* CONTENT CONTAINER */}
        <div className="grid grid-cols-1 xxs:grid-cols-6 xs:grid-cols-10 gap-2 items-center justify-center">
    
          {/* LEFT SIDE CONTAINER */}
          <div className="lg:sticky col-span-1 xxs:col-span-2 xs:col-span-3 flex-1 relative">
